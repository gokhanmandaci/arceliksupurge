...
extension MainVC {
    ...
    private func setButtons(_ btn: UIButton) {
        ...
        case 1:
            ...
            lblLeftDba.text = "\(dbaArr[0]) dB(A) [ortalama]"
        ...
        case 2:
            ...
            lblLeftDba.text = "\(dbaArr[1]) dB(A) [ortalama]"
        ...
        case 3:
            ...
            lblLeftDba.text = "\(dbaArr[2]) dB(A) [ortalama]"
        ...
        case 4:
            ...
            lblLeftDba.text = "\(dbaArr[3]) dB(A) [ortalama]"
        ...
        case 5:
            ...
            lblLeftDba.text = "\(dbaArr[4]) dB(A) [ortalama]"
